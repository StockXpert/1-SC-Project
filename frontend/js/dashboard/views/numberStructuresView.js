...
class NumberStructuresView extends View {
  _parentElement = document.getElementById('heading-table-text-structures');
  _table = document.querySelector('.table-structures');
  _checkboxes = this._table.querySelectorAll('input[type="checkbox"]');
  _masterCheckbox = document
    .querySelector('.table-container-structures')
  ...
  **/
  ...
  _generateMarkup() {
    ...
    return `
      <p class="table-text">
        Tout les Structures (<b class="number-users">${
  ...
  addHandlerNumber(fn) {
    fn();
    this._table = document.querySelector('.table-structures');
...
export default new NumberStructuresView();
