...
async function addRow(ligne,Content,idCopy,type)
{
    try {
        ...
        if(type!='sortie'&&type!='decharge'&&type!='registre'&&type!='fiche'){  
...
module.exports={generatePDF,getCopy,updateCel,addRow,deleteRows,addBorder,generateCSV,uploadImageToDrive,insertImageURLInSheet};